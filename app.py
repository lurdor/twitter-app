...
Database.initialise(user='postgres', host='localhost',password='1234',database='learning')
...
@app.route('/auth/twitter') #127.0.0.1:4995/auth/twitter?oauth_token=9vBSWwAAAAAA870zAAABZyzXCYM&oauth_verifier=Yf5UTVmUaPq0rKa2euN7tQosfZxbHZdc
def twitter_auth():
